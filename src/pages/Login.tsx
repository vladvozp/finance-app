  ...
  return (
    <main className="py-10 flex flex-col">
      ...
      <div className="mt-6 mx-auto w-full max-w-md">
        ...
        <div className="group relative cursor-zoom-in bg-gray-100/60 rounded-xl p-3 border border-gray-200/50 shadow-[0_4px_20px_rgba(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] overflow-hidden">
          <img
            src="/preview.png"
